...
public class Controller {
    ...
    // ponemos un circuit breaker a este metodo ingresando el nombre y el metodo
    ...
    private ResponseEntity<List<Car>> fallBackSaveBike(@PathVariable("userId") int userId, @RequestBody Bike bike, RuntimeException e){
